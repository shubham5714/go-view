...
public class EmailVerificationServiceImpl extends ServiceImpl<EmailVerificationMapper, EmailVerification>
    ...
    @Value("${sendgrid.from-name:DRX EYE}")
    ...
    private String buildSignupEmailBody(String code) {
        return "<!DOCTYPE html>" +
                "<html lang=\"en\">" +
                "<head><meta charset=\"UTF-8\"><title>DRX-EYE verification code</title></head>" +
                "<body style=\"font-family: Arial, sans-serif; font-size: 14px; color: #222;\">" +
                "<p>Hi,</p>" +
                "<p>Your <strong>DRX-EYE</strong> verification code is:</p>" +
                "<p style=\"font-size: 20px; font-weight: bold; letter-spacing: 3px;\">" + code + "</p>" +
                "<p>This code will expire in <strong>10 minutes</strong>.</p>" +
                "<p>If you did not request this code, you can safely ignore this email.</p>" +
                "<p>Thanks,<br/>DRX-EYE Team</p>" +
                "</body></html>";
    }
    ...
    private void sendEmail(String toEmail, String body) {
        ...
        Mail mail = new Mail(from, "DRX-EYE verification code", to, content);
